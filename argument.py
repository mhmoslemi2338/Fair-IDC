...
# --- INSERT THIS BLOCK ---
if args.dataset.startswith('Colored_MNIST') or args.dataset.startswith('Colored_FashionMNIST'):
    args.nclass = 10
    args.size = 32   # Important: Must be 32 to match ConvNet-3 input
    args.nch = 3     # Important: These are RGB images
    args.mix_p = 0.5
    args.dsa = True
    # Digits and clothes should not be flipped horizontally
    args.dsa_strategy = remove_aug(args.dsa_strategy, 'flip')
# -------------------------
